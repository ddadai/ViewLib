...
public class SharedPreferencesUtil {
    ...
    private static String spName = "net.pingzhuo.yfgb_date";
...
//    public static void put(String s, boolean v) {
//        put(s, v);
//    }
//
//    public static void put(String s, float v) {
//        put(s, v);
//    }
//
//    public static void put(String s, int v) {
//        put(s, v);
//    }
//
//    public static void put(String s, long v) {
//        put(s, v);
//    }
//
