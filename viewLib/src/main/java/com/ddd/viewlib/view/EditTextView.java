...
public class EditTextView extends LinearLayout{
	...
	public EditTextView(Context context, AttributeSet attrs) {
		...
		imgIcon.setImageResource(a.getResourceId(R.styleable.tabWidget_iconColor,
		...
		textColor = a.getColor(R.styleable.tabWidget_textColor, context.getResources().getColor(R.color.white))
				| a.getInteger(R.styleable.tabWidget_textColor, context.getResources().getColor(R.color.white));
