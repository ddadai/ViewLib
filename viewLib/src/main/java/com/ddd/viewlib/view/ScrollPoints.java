...
public class ScrollPoints extends LinearLayout implements SelectPoint {
    ...
    public ScrollPoints(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
//		pointBox = new LinearLayout(getContext());
    }
    ...
    public void initPoints(Context context, int count, int gravity, int selected, int drawable_normal, int drawable_focused) {
        this.removeAllViews();
