...
import com.ddd.viewlib.utils.ViewUtils;
...
//		}
		...
		for (int i = 0; i <imageSize; i++) {
			ImageView imageView = new ImageView(mContext);
			String imageUrl=mCustomBannerImageAdapter.getImageUri(imageView,i);
			if(imageUrl!=null){
...
//			timers[i]=3;
		...
		viewPager.setAdapter(mAdapter);
		dotLayout.initPoints(mContext, imageSize,dotGravity, 0,dotNormalDrawable, dotFocusDrawable);
...
//	}
	...
	public static abstract class CustomBannerImageAdapter{
		...
		public abstract String getImageUri(ImageView img,int position);
