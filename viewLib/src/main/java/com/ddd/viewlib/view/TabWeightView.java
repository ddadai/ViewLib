...
import com.ddd.viewlib.view.interfaces.OnTabItemClickListener;
import com.ddd.viewlib.view.interfaces.OnTabItemClickListener.TabViewItem;
...
//		mTextWidths=new ArrayList<Float>();
	...
	public TabViewItem getItem(int index){
		if(mTabs==null||mIndex>mTabs.size()-1||mIndex<0){
			return null;
		}
