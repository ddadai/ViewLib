...
import com.ddd.viewlib.view.interfaces.LabelCheck;
...
//		int index=0;//记录行数中的第n－1个
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < adapter.getCount(); i++) {
                ...
                if (view != null) {
                    ...
                    if(mode==Mode.single_must_one&&adapter.getCount()==1){
                        return;
                    }
    ...
    public abstract static class LabelAdapter {
        ...
        private List<? extends LabelCheck> models;

        public abstract View getView(int position, boolean check, View childView);

        public void setModels(List<? extends LabelCheck> models) {
            this.models = models;
            notifyDataChange();
        }
    ...
    public static class SimpleLabel implements LabelCheck {
        ...
        public SimpleLabel(boolean isCheck, String label) {
